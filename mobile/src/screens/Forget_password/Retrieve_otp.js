...
const Retrieve_otp = () => {
  return (
    <VStack space="2.5"  px="3" mx="3"  backgroundColor="#fff" flex={1} >
        ...
        <Box   >
          <Text style={{ textAlign: 'left',color:'#000',fontWeight:'bold',fontSize:18 }} >Enter 4-digit code sent to you via SMS or Email  </Text>
          <Text style={{ fontWeight:'normal',color:'#000'}}>Please enter the code sent to the number ending in 23564</Text>
        </Box>
